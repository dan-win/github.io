// Source: https://github.com/grofit/knockout.chart
(function (factory) {
...
(function (ko, Chart, exports) {
    ...
    var convertAllDataToNumeric = function(model) {
        ...
        {
            if (model.forEach) model.forEach(function(datapoint){
    ...
    ko.bindingHandlers.chart = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel) {
            ...
            var createChart = function() {
                ...
                if (chartBinding.legend) chartBinding.legend(activeChart.generateLegend());
            };
            ...
            // createChart();
            // Needs to ensure that we drawing on a visible canvas and its' dimensions are non-zero:
